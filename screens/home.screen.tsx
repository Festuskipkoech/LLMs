import {
  ...
  const genAI:any = new GoogleGenerativeAI(process.env.EXPO_PUBLIC_GEMINI_API_KEY);
  ...
  export default function HomeScreen() {
    ...
    const stopRecording = async () => {
      try {
        ...
        const transcript:any = await sendAudioToWhisper(uri!);
    ...
    const sendAudioToWhisper = async (uri: string) => {
      try {
        ...
        const result = await model.generateContent([audioData])
